<template>
  <card ref="Card">
    <div slot="header">
      ...
      <el-select placeholder="选择职务搜索" v-model="searchByJob" clearable @change="getData" class="ml-5">
        <el-option v-for="item in jobList" :label="item.name" :value="item.id" :key="item.id"/>
      </el-select>
      <el-button type="success" class="el-icon-search ml-5" @click="getData">搜索</el-button>
      <el-button class="float-right" type="primary" icon="el-icon-plus" @click="add" v-permission="'addUser'">新增</el-button>
    </div>
