<template>
  <el-dialog
    ...
    <el-form :model="form" :rules="rules" ref="Form" label-width="100px">
      ...
      <el-form-item label="分类" prop="videoSortId">
        <el-select v-model="form.videoSortId" clearable>
...
<script>
  import {editVideoManageApi} from '@/api/study/video';
    ...
    data() {
      return {
        ...
        rules: {
          ...
          videoSortId: {required: true, message: '请选择分类', trigger: 'change'},
    ...
    methods: {
      submit() {
        this.$refs['Form'].validate((valid) => {
          ...
          editVideoManageApi(data).then(result => {
